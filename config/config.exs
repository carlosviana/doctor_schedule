...
config :doctor_schedule, DoctorScheduleWeb.Auth.Guardian,
  ...
  secret_key:
    System.get_env("GUARDIAN_SECRET") ||
      "nJ0Nq7L4l31Wil3uJ90KX++CvCrTbbZysnM2eRgLfjTpKalBsXAUCfzrl+yYK8MT"
